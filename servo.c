...
#define SERVO_CHANNEL_PIN_0 LATAbits.LATA5
#define SERVO_CHANNEL_PIN_1 LATAbits.LATA5
#define SERVO_CHANNEL_PIN_2 LATAbits.LATA5
#define SERVO_CHANNEL_PIN_3 LATAbits.LATA5
#define SERVO_CHANNEL_PIN_4 LATAbits.LATA5
#define SERVO_CHANNEL_PIN_5 LATAbits.LATA5
#define SERVO_CHANNEL_PIN_6 LATAbits.LATA5
#define SERVO_CHANNEL_PIN_7 LATAbits.LATA5
